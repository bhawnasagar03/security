...
<section id="sign_section" style="margin-left: 300px;" >
    ...
    <div class="panel panel-primary signpanel col-md-8 right">
        ...
        <div class="panel-body mypanel">
            <form action="{{ route('updateGuardProfile') }}" method="post" enctype="multipart/form-data">
                @csrf
                {{csrf_field()}}
               ...
               <!--  <div class="input-group col-md-6"> -->
                 ...
                 <!--    Change Profile<input type="file" id="img" name="image" value="{{$guard->guardProfile->image}}">
                </div> -->
        </div>
